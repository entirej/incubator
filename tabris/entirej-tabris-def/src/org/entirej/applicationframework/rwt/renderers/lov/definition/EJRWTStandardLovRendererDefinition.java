...
public class EJRWTStandardLovRendererDefinition implements EJDevLovRendererDefinition
{
    @Override
    ...
    {
        return "org.entirej.applicationframework.rwt.renderers.lov.EJRWTStandardLovRenderer";
    }
