...
public class CompaniesActionProcessor extends DefaultFormActionProcessor
{
    ...
    public void postDelete(EJForm form, EJRecord record) throws EJActionProcessorException
    {
        ...
        // form.saveChanges();
        // // validate the company information toolbar state after deleting
        // company
        // // information record
        // if (F_COMPANY.B_COMPANIES.ID.equals(record.getBlockName()))
        // {
        // validateToolbarState(form.getBlock(F_COMPANY.B_COMPANY_TOOLBAR.ID),
        // form.getBlock(F_COMPANY.B_COMPANIES.ID).getFocusedRecord() != null);
        // }
