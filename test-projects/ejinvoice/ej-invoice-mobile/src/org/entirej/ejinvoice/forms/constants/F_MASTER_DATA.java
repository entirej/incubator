...
public class F_MASTER_DATA
{
    ...
    public static class B_CONTACT_TYPES_TITLE
    {
        public static final String ID      = "ContactTypesTitle";
    ...
    public static final String C_CONTACT_TYPES_GROUP = "ContactTypesGroup";
    public static final String C_CONTACT_TYPES_TITLE = "ContactTypesTitle";
