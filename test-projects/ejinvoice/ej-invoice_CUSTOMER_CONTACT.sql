...
CREATE TABLE `CUSTOMER_CONTACT` (
  ...
  KEY `fk_CUSTOMER_CONTACT_USER1_idx` (`USER_ID`),
  ...
  CONSTRAINT `fk_CUSTOMER_CONTACT_USER1` FOREIGN KEY (`USER_ID`) REFERENCES `USER` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
