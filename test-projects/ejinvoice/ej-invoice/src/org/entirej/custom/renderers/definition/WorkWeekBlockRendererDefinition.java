...
public class WorkWeekBlockRendererDefinition implements EJDevBlockRendererDefinition
{
    ...
    public WorkWeekBlockRendererDefinition()
    {
    ...
    {
        return "org.entirej.custom.renderers.WorkWeekBlockRenderer";
    }
