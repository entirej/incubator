...
/**
 * This class is used as a service to validate delete record usage from constraints violations
 */
public class DBService
{
    ...
    /**
     * Checks and validate if a given record is clear from database constraints violation and if
     * caught throws an exception
     * 
     * @param focusedRecord
