...
public class InvoiceProjectTime
{
    private EJPojoProperty<String>     _removeFromInvoice;
    ...
    @EJFieldName("REMOVE_FROM_INVOICE")
    public String getRemoveFromInvoice()
    {
        return EJPojoProperty.getPropertyValue(_removeFromInvoice);
    }

    @EJFieldName("REMOVE_FROM_INVOICE")
    public void setRemoveFromInvoice(String removeFromInvoice)
    {
        _removeFromInvoice = EJPojoProperty.setPropertyValue(_removeFromInvoice, removeFromInvoice);
    }

    @EJFieldName("REMOVE_FROM_INVOICE")
    public String getInitialRemoveFromInvoice()
    {
        return EJPojoProperty.getPropertyInitialValue(_removeFromInvoice);
    }
    ...
    public void clearInitialValues()
    {
        ...
        EJPojoProperty.clearInitialValue(_removeFromInvoice);
    }
