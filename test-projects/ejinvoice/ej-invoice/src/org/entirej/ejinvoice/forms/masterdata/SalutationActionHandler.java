...
public class SalutationActionHandler extends DefaultFormActionProcessor
{
    ...
    public void executeActionCommand(EJForm form, EJRecord record, String command, EJScreenType screenType) throws EJActionProcessorException
    {
        if (record.getBlockName() != null
                && ((record.getBlockName().equals(F_MASTER_DATA.B_SALUTATIONS.ID)) || record.getBlockName().equals(F_MASTER_DATA.B_SALUTATIONS_TOOLBAR.ID)))
        {
            ...
            if (F_MASTER_DATA.AC_TOOLBAR_DELETE.equals(command) && form.getBlock(F_MASTER_DATA.B_SALUTATIONS.ID).getFocusedRecord() != null)
            {
                ...
                ServiceRetriever.getDBService(form)
                        .validateDeleteRecordUsage(form.getBlock(F_MASTER_DATA.B_SALUTATIONS.ID).getFocusedRecord(), "SALUTATIONS");
    ...
    {
        // validate the salutations toolbar state after deleting salutations record
        if (F_MASTER_DATA.B_SALUTATIONS.ID.equals(record.getBlockName()))
        {
            validateToolbarState(form.getBlock(F_MASTER_DATA.B_SALUTATIONS_TOOLBAR.ID), form.getBlock(F_MASTER_DATA.B_SALUTATIONS.ID).getFocusedRecord() != null);
        }
    }
    ...
    public void validateRecord(EJForm form, EJRecord record, EJRecordType recordType) throws EJActionProcessorException
    {
        ...
        if (F_MASTER_DATA.B_SALUTATIONS.ID.equals(record.getBlockName()))
        {
            ...
            final EJScreenItem screenItem = form.getBlock(F_MASTER_DATA.B_SALUTATIONS.ID).getScreenItem(EJScreenType.MAIN,
    ...
    public void newRecordInstance(EJForm form, EJRecord record) throws EJActionProcessorException
    {
        ...
        {
            validateToolbarState(form.getBlock(F_MASTER_DATA.B_SALUTATIONS_TOOLBAR.ID), record != null);
