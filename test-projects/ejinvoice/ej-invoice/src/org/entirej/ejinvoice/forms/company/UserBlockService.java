...
public class UserBlockService implements EJBlockService<User>
{
    ...
    private String                    _selectStatement = "SELECT GENDER, DATE_OF_BIRTH, ADDRESS,COMPANY_ID,EMAIL,FIRST_NAME,ID,LAST_NAME,LOCALE_COUNTRY,LOCALE_LANGUAGE,NOTES,PASSWORD,POST_CODE,TOWN, ROLE, ACTIVE FROM user";
    ...
    public void executeInsert(EJForm form, List<User> newRecords)
    {
        ...
        for (User record : newRecords)
        {
            ...
            parameters.add(new EJStatementParameter("DATE_OF_BIRTH", Date.class, record.getDateOfBirth()));
            parameters.add(new EJStatementParameter("GENDER", String.class, record.getGender()));
    ...
    public void executeUpdate(EJForm form, List<User> updateRecords)
    {
        ...
        for (User record : updateRecords)
        {
            ...
            parameters.add(new EJStatementParameter("POST_CODE", String.class, record.getPostCode()));
            parameters.add(new EJStatementParameter("TOWN", String.class, record.getTown()));
            parameters.add(new EJStatementParameter("DATE_OF_BIRTH", String.class, record.getDateOfBirth()));
            parameters.add(new EJStatementParameter("GENDER", String.class, record.getGender()));
