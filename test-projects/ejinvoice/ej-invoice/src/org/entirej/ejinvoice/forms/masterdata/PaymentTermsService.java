...
public class PaymentTermsService
{
     ...
     */
    public static boolean paymentTermExists(EJForm  form, String term, Integer id)
    {
        if (term == null)
        {
        ...
        List<EJSelectResult> results = executor.executeQuery(form.getConnection(), PAYMENT_TERMS_EXIST_STMT, criteria);
