...
public class VATRatesService
{
     ...
     */
    public static boolean vatRateNameExists(EJForm form, String name, Integer id)
    {
        if (name == null)
        {
        ...
        List<EJSelectResult> results = executor.executeQuery(form.getConnection(), VAT_RATES_EXIST_STMT, criteria);
