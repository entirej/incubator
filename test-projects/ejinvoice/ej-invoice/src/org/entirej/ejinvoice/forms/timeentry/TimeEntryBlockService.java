...
public class TimeEntryBlockService implements EJBlockService<TimeEntry>
{
    ...
    private String                    _selectStatement = "SELECT COMPANY_ID, INVP_ID, "
    		+ "CUPT_ID,END_TIME,ID,START_TIME,USER_ID,WORK_DATE,WORK_DESCRIPTION, "
    		+ "(SELECT CPR_ID FROM CUSTOMER_PROJECT_TASKS WHERE ID = CUPT_ID) CUPR_ID "
