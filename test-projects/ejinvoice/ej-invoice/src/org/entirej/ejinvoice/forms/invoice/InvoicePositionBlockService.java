...
public class InvoicePositionBlockService implements EJBlockService<InvoicePosition>
{
    ...
    @Override
    public List<InvoicePosition> executeQuery(EJForm form, EJQueryCriteria queryCriteria)
    {
        return _statementExecutor.executeQuery(InvoicePosition.class, form, _selectStatement, queryCriteria);
    }

    @Override
    public void executeInsert(EJForm form, List<InvoicePosition> newRecords)
    {
        List<EJStatementParameter> parameters = new ArrayList<EJStatementParameter>();
        int recordsProcessed = 0;
        for (InvoicePosition record : newRecords)
        {
    ...
    @Override
    public void executeUpdate(EJForm form, List<InvoicePosition> updateRecords)
    {
        List<EJStatementParameter> parameters = new ArrayList<EJStatementParameter>();

        int recordsProcessed = 0;
        for (InvoicePosition record : updateRecords)
        {
            parameters.clear();
    ...
    @Override
    public void executeDelete(EJForm form, List<InvoicePosition> recordsToDelete)
    {
        ArrayList<EJStatementParameter> parameters = new ArrayList<EJStatementParameter>();

        int recordsProcessed = 0;
        for (InvoicePosition record : recordsToDelete)
        {
            parameters.clear();
