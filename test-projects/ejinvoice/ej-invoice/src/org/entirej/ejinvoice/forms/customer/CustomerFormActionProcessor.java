...
public class CustomerFormActionProcessor extends DefaultFormActionProcessor
{
    ...
    //
    // @Override
    // public void executeActionCommand(EJForm form, EJRecord record, String
    // command, EJScreenType screenType) throws EJActionProcessorException
    // {
    //
    ...
    // return;
    // }
    // if (F_CUSTOMER.AC_TOOLBAR_DELETE.equals(command) &&
    // form.getBlock(F_CUSTOMER.B_CUSTOMER.ID).getFocusedRecord() != null)
    // {
    ...
    // ServiceRetriever.getDBService(form).validateDeleteRecordUsage(form.getBlock(F_CUSTOMER.B_CUSTOMER.ID).getFocusedRecord(),
    // "CUSTOMER");
    //
    ...
    // ((record.getBlockName().equals(F_CUSTOMER.B_CUSTOMER_CONTACTS.ID)) ||
    // record.getBlockName().equals(F_CUSTOMER.B_CUST_CONTACT_TOOLBAR.ID)))
    // {
    ...
    // return;
    // }
    // if (F_CUSTOMER.AC_DELETE_CONTACT.equals(command) &&
    // form.getBlock(F_CUSTOMER.B_CUSTOMER_CONTACTS.ID).getFocusedRecord() !=
    // null)
    // {
    ...
    //
    // @Override
    // public void postInsert(EJForm form, EJRecord record) throws
    // EJActionProcessorException
    // {
    // if(F_CUSTOMER.B_CUSTOMER.ID.equals(record.getBlockName()))
    // {
    // validateToolbarState(form.getBlock(F_CUSTOMER.B_CUSTOMER_TOOL_BAR.ID),
    // form.getBlock(F_CUSTOMER.B_CUSTOMER.ID).getFocusedRecord() != null);
    // }
    ...
    //
    // @Override
    // public void postDelete(EJForm form, EJRecord record) throws
    // EJActionProcessorException
    // {
    ...
    //
    // @Override
    // public void postBlockQuery(EJForm form, EJBlock block) throws
    // EJActionProcessorException
    // {
    ...
    // form.getBlock(F_CUSTOMER.B_CUSTOMER_CONTACTS.ID);
    ...
    // form.getBlock(F_CUSTOMER.B_CUST_CONTACT_TOOLBAR.ID);
    // toolbarBlock.getScreenItem(EJScreenType.MAIN,
    // F_CUSTOMER.B_CUST_CONTACT_TOOLBAR.I_DELETE).setEditable(contactRecord !=
    // null);
    // toolbarBlock.getScreenItem(EJScreenType.MAIN,
    // F_CUSTOMER.B_CUST_CONTACT_TOOLBAR.I_EDIT).setEditable(contactRecord !=
    // null);
    // }
    //
    //
