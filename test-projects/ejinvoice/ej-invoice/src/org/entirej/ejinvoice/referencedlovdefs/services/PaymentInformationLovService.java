...
import org.entirej.ejinvoice.referencedlovdefs.services.pojos.PaymentInformation;
...
public class PaymentInformationLovService implements EJBlockService<PaymentInformation>
{
    private final EJStatementExecutor _statementExecutor;
    private String                    _selectStatement = "SELECT ID,PAYMENT_TERMS FROM PAYMENT_INFORMATION";

    public PaymentInformationLovService()
    {
