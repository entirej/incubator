...
import org.entirej.ejinvoice.referencedlovdefs.services.pojos.User;
...
public class UserBlockService implements EJBlockService<User>
{
    ...
    private String                    _selectStatement = "SELECT ACTIVE,ADDRESS,COMPANY_ID,EMAIL,FIRST_NAME,ID,LAST_NAME,LOCALE_COUNTRY,LOCALE_LANGUAGE,NOTES,PASSWORD,POST_CODE,ROLE,TOWN FROM user";
    ...
    {
        return _statementExecutor.executeQuery(User.class, form, _selectStatement, queryCriteria);
    }
