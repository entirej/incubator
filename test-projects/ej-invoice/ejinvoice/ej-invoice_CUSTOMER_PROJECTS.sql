...
CREATE TABLE `CUSTOMER_PROJECTS` (
  ...
  KEY `fk_CUSTOMER_PROJECTS_USER1_idx` (`USER_ID`),
  ...
  CONSTRAINT `fk_CUSTOMER_PROJECTS_USER1` FOREIGN KEY (`USER_ID`) REFERENCES `USER` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
